namespace TesterXunit
{
    public class OperacoesTests // Define a classe de testes "OperacoesTests".
    {
        ...
        public void SomarDoisNumeroRetornarResultado()
        {
            ...
            var resultado = OperacoesTests.Somar(primeiroNumero, segundoNumero);
            // Chama o método "Somar" da classe "Operacoes" passando os doi
            //s números definidos anteriormente e armazena o resultado.
        ...
        public void SomaDoisNumeros_RetornarResultado_ParaListaDeValores(double primeiroNumero, double segundoNumero, double resultadoEsperado)
        {
            ...
            var resultadoDaSoma = OperacoesTests.Somar(primeiroNumero, segundoNumero);
